...
<div id="<?php echo esc_attr($this->add_id(array('awsm-team', $id))); ?>" class="awsm-grid-wrapper">
    ...
    <div class="awsm-grid<?php echo esc_attr($this->item_style($options)); ?>">
        <?php
            ...
            ?>
        <div id="<?php echo esc_attr($this->add_id(array('awsm-member', $id, $team->post->ID))); ?>"
            class="awsm-grid-card awsm-team-item awsm-scale-anm<?php echo esc_attr($member_terms); ?>">
            <figure>
